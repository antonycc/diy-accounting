# Reconciliation Report: GB Accounts Company 2026-12-31 (Dec26) Excel 2007
...
| &nbsp;&nbsp;&nbsp;&nbsp;Directors Loan | 1,914,873 |
| **Net Assets** | -1,496,179.22 |
| &nbsp;&nbsp;&nbsp;&nbsp;Share Capital | 100 |
...
| | Amount |
|---|------:|
| Audit Accuracy Check | -1,765,126 |
...
| D29 | Directors Loan | 1914873 | accounts.liabilities.2500 (pubBS) |
| F33 | **Net Assets** | -1496179.2225 | gl-cor:amount (pubBS.netAssets) |
...
| Cell | DIY Label | Value | diya-gl mapping |
|------|-----------|-------|-----------------|
| EJ91 | Audit Accuracy Check | -1765126 | gl-cor:amount (trialBalanceCheck) |
