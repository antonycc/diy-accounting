# Reconciliation Report: GB Accounts Company 2027-01-31 (Jan27) Excel 2007
...
| &nbsp;&nbsp;&nbsp;&nbsp;Directors Loan | 1,916,118 |
| **Net Assets** | -1,497,424.22 |
| &nbsp;&nbsp;&nbsp;&nbsp;Share Capital | 100 |
...
| | Amount |
|---|------:|
| Audit Accuracy Check | -1,766,371 |
...
| D29 | Directors Loan | 1916118 | accounts.liabilities.2500 (pubBS) |
| F33 | **Net Assets** | -1497424.2225 | gl-cor:amount (pubBS.netAssets) |
...
| Cell | DIY Label | Value | diya-gl mapping |
|------|-----------|-------|-----------------|
| EJ91 | Audit Accuracy Check | -1766371 | gl-cor:amount (trialBalanceCheck) |
