# Reconciliation Report: GB Accounts Company 2025-11-30 (Nov25) Excel 2007
...
| &nbsp;&nbsp;&nbsp;&nbsp;Directors Loan | 1,913,625 |
| **Net Assets** | -1,494,931.22 |
| &nbsp;&nbsp;&nbsp;&nbsp;Share Capital | 100 |
...
| | Amount |
|---|------:|
| Audit Accuracy Check | -1,763,878 |
...
| D29 | Directors Loan | 1913625 | accounts.liabilities.2500 (pubBS) |
| F33 | **Net Assets** | -1494931.2225 | gl-cor:amount (pubBS.netAssets) |
...
| Cell | DIY Label | Value | diya-gl mapping |
|------|-----------|-------|-----------------|
| EJ91 | Audit Accuracy Check | -1763878 | gl-cor:amount (trialBalanceCheck) |
