...
//
// Reads:  web/www.spreadsheets.diyaccounting.co.uk/redirects.toml
// Writes: web/www.spreadsheets.diyaccounting.co.uk/redirect-function.js

const fs = require("fs");
const path = require("path");

const ROOT = path.resolve(__dirname, "..");
const TOML_PATH = path.join(ROOT, "web", "www.spreadsheets.diyaccounting.co.uk", "redirects.toml");
const OUTPUT_PATH = path.join(ROOT, "web", "www.spreadsheets.diyaccounting.co.uk", "redirect-function.js");
...
// Redirects old www.spreadsheets.diyaccounting.co.uk URLs to new locations
function handler(event) {
  ...
  var hosts = {
    spreadsheets: isCI ? 'ci-feature-b.spreadsheets.diyaccounting.co.uk' : 'feature-b.spreadsheets.diyaccounting.co.uk',
    submit: isCI ? 'ci.feature-a.spreadsheets.diyaccounting.co.uk' : 'feature-a.spreadsheets.diyaccounting.co.uk'
  };
